...
function showSeats(){
    ...
    for(var i=0; i<5; i++){
        ...
        for(var j=0; j<10; j++){
            document.getElementById('t'+i).innerHTML += '<td><a onclick="seatSelect(id)" id="'+d+""+j+'"><img src="available.png" alt="available"/></a></td>';
        }
    }
}
...
function seatSelect(id){
    ...
    if(selectSeats.length < nos){
        document.getElementById(id).outerHTML = '<a onclick="unSelect(id)" id="'+id+'"><img src="selected.png" alt="selected" /></a>';
        selectSeats.push(id);
...
function unSelect(id){
    //console.log(id);
    document.getElementById(id).outerHTML = '<a onclick="seatSelect(id)" id="'+id+'"><img src="available.png" alt="available" /></a>';
